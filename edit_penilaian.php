...
<?php
    ...
    if (isset($_POST['edit'])) {
        ...
        if ($hasil) {
            echo "<script>
            alert('Penilaian Berhasil Di Ubah.');
            window.location.href= 'penilaian.php';
            </script>";
        } else {
            echo "<script>
            alert('Opps, Penilaian Gagal Di Ubah !');
            </script>";
        }
    }
?>
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="merek" class="form-control col-lg-8"
                                        value="<?= $row['merek']; ?>">
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <select name="memori" id="" class="form-control col-lg-10">
                                        ...
                                        <option value="4">Diatas 120 GB</option>
                                        <option value="5">Diatas 250 GB</option>
                                    </select>
                                </div>
